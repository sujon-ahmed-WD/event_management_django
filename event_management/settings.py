...
SECRET_KEY = 'django-insecure-@*e*8rw4p_-mt)7h24$y_-z1gxiao348rj#-f@w-tbo90lvf1e'
DEBUG = True
ALLOWED_HOSTS = ['*', 'event-management-django-gidq.onrender.com']
...
CSRF_TRUSTED_ORIGINS = [
    'https://*.onrender.com',
    'http://127.0.0.1:8000',
    'https://event-management-django-gidq.onrender.com'
]

# DATABASE - Render Postgres with SSL
DATABASES = {
    'default': dj_database_url.config(
        default="postgresql://event_management_whd6_user:PASS@dpg-d1loeemmcj7s73apikh0-a.oregon-postgres.render.com/event_management_whd6?sslmode=require",
        conn_max_age=600,
        ssl_require=True
    )
}
